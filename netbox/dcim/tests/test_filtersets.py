...
class VirtualLinkTestCase(TestCase, ChangeLoggedFilterSetTests):
    ...
    def setUpTestData(cls):
        ...
        interfaces = (
            ...
            Interface(device=devices[3], name='Interface 7', type=InterfaceTypeChoices.TYPE_VIRTUAL),
            Interface(device=devices[3], name='Interface 8', type=InterfaceTypeChoices.TYPE_VIRTUAL),
        )
        Interface.objects.bulk_create(interfaces)
